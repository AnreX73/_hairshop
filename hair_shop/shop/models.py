...
class Product(models.Model):
    ...
    hair_shade = models.CharField(max_length=200, choices=HAIRSHADES, verbose_name='Оттенок', default='other')
    color = models.CharField(max_length=200, verbose_name='Цвет', default='')
    hair_length = models.CharField(max_length=200, verbose_name='Длина волос', default='')
    hair_width = models.CharField(max_length=200, verbose_name='Ширина волос', default='')
    hair_material = models.CharField(max_length=200, verbose_name='Материал волос', default='')
    number_of_strands = models.CharField(max_length=200, verbose_name='Количество прядей', default='')
    hair_extension_method = models.CharField(max_length=200, verbose_name='Метод прикрепления', default='')
    hair_type = models.CharField(max_length=200, verbose_name='Тип волос или канекалона', default='')
    country_of_origin = models.CharField(max_length=200, verbose_name='Страна происхождения', default='')
    description = models.TextField(blank=True, verbose_name='Описание', default='')
    kit = models.CharField(max_length=200, verbose_name='Комплектация', default='')
    decoration = models.CharField(max_length=200, verbose_name='Декоративные элементы', default='')
    package = models.CharField(max_length=200, verbose_name='размер упаковки', default='')
    rating = models.DecimalField(max_digits=2, decimal_places=1, verbose_name='Рейтинг', default=4.5)
